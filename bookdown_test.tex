...
Today we are going to work with the Palmer Penguins dataset from the \texttt{palmerpenginus}package. Install the package as follows:
...
We are writing this in R Markdown beause you can do all sorts of things in R Markdown, such as embedding code in text: 2 + 2 = 4

\hypertarget{the-dataset}{%
\section{The dataset}\label{the-dataset}}

Lets take a look at the dataset available in the \texttt{palmerpenguins} package:
...
\hypertarget{penguin-measurments}{%
\subsection{Penguin measurments}\label{penguin-measurments}}

The table \texttt{penguins} includes the following measurments:
...
{\centering \includegraphics{bookdown_test_files/figure-latex/unnamed-chunk-1-1} 

}

\caption{My plot}\label{fig:unnamed-chunk-1}
\end{figure}
